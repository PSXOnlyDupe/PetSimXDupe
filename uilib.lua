...
function Library.Init(options)
    ...
    if _G.Settings.Position == nil then
        ...
        save()
            ...
            Shadow.BorderColor3 = Color3.fromRGB(255,85,51)
            ...
            Title2.Position = UDim2.new(0.0900000033, 0, 0, 0)
            ...
            function Tabs:Tab(tabname)
                ...
                function Sections:Section(sectionname)
                    ...
                    lbl.BorderColor3 = Color3.fromRGB(255,85,51)
                ...
                function Elements:NewButton(options)
                   ...
                   if not options then options = {} end 
                    ...
                    ButtonContainer.BorderColor3 = Color3.fromRGB(2255,85,51)
                ...
                DropdownContainer.BorderColor3 = Color3.fromRGB(255,85,51)
                ...
                TextBox.BorderColor3 = Color3.fromRGB(255,85,51)
		...
		SliderTitle.Text = slidertitle
            ...
            function Elements:NewLabel(options)
				...
				ButtonContainer.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
				ButtonContainer.BackgroundTransparency = 1.000
				ButtonContainer.BorderColor3 = Color3.fromRGB(255,85,51)
				ButtonContainer.Size = UDim2.new(0, 500, 0, 38)
